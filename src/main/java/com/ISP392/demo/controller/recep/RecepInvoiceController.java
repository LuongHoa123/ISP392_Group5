...
public class RecepInvoiceController {
    ...
    public String addInvoice(
        ...
        if (appointment == null) {
            ...
            return "redirect:/recep/invoice/" + appointmentId;
        }
    ...
    public String getPaymentInfo(@RequestParam("vnp_ResponseCode") String vnp_ResponseCode,
        ...
        if ("00".equals(vnp_ResponseCode)) {
            ...
            if (appointment == null) {
                redirectAttributes.addFlashAttribute("errorMessage", "Lịch hẹn không tồn tại!");
                return "redirect:/recep/invoice/after-checkout";
            }
